SMODS.Joker {
    ...
    calculate = function(self, card, context)
        ...
        if context.pseudorandom_result and (not context.result and not mxms_is_invert_prob_check(context.trigger_obj) or context.success and mxms_is_invert_prob_check(context.trigger_obj)) and not context.blueprint then
