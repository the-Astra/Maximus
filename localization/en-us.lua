return {
        ...
        Joker = {
            ...
            j_mxms_detective = {
                ...
                text = {
                    ...
                    'the first {C:attention}#1#{} cards drawn',
        ...
        Other = {
            ...
            mxms_credits = {
                text = {
                    ' {element:1} {}',
                    '{s:0.4} {}',
                    '{B:1,C:white}Lead Programmer:{} {C:purple}theAstra',
    ...
    misc = {
        achievement_descriptions = {
            ...
            ach_mxms_scars = "Discover every Legendary Joker from Maximus",
        ...
        achievement_names = {
            ...
            ach_mxms_scars = "Wanna Know How I Got These Scars?",
