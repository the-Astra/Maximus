return {
    descriptions = {
        Mod = {
            Maximus = {
                ...
                text = {
                    " {element:1} {}",
                    " ",
                    "{s:1.3}一个力求保留{s:1.3,C:dark_edition,E:2}Vanilla+{s:1.3}体验的模组",
                    "保留游戏原版风味",
                    "{s:0.8,C:inactive}(多数情况下 尤其是核爆牌组)",
                    "也加入新点子让体验保持新鲜",
                    " ",
                    " ",
                    "{C:blue,u:blue,button:mxms_discord}点击加入 Discord!",
                },
            },
        },
        Back = {
            ...
            b_mxms_censored = {
                ...
                text = {
                    "每轮底注结束时",
                    "打开一个{C:conspiracy,T:p_mxms_classified_mega_1}#1#{}",
                },
            },
            b_mxms_destiny = {
                name = "命运牌组",
            ...
            b_mxms_empire = {
                ...
                text = {
                    "{C:tarot}秘术包{}包含",
                    "{C:attention}所有{}可用的{C:tarot}塔罗牌{}",
                },
            },
            b_mxms_grilled = {
                name = "烧烤牌组",
            ...
            b_mxms_nuclear = {
                ...
                text = {
                    ...
                    "盲注大小乘以",
                    "{C:red}底注次方{}",
                    "{C:inactive}本牌组不计入最佳出牌得分",
                    "{C:inactive}或分数相关解锁",
                    "{s:0.8,C:inactive}安装Amulet模组后效果最佳",
                },
            },
            b_mxms_professional = {
                name = "专家牌组",
            ...
            b_mxms_scarred = {
                ...
                text = {
                    ...
                    "{C:legendary}传奇{C:dark_edition,E:1}Maximus{}小丑牌",
                    "{C:red}#1#{}小丑牌槽位",
                    "{C:inactive,s:0.8}(生成的牌不会加入发现记录)",
                },
            },
            b_mxms_sixth_finger = {
                name = "第六指牌组",
        ...
        Conspiracy = {
            ...
            c_mxms_coverup = {
                ...
                text = {
                    "{C:green}#1#/#2#{}几率",
                    "摧毁1张选定的{C:attention}增强牌{}",
                    "并替换为{C:attention}#3#{}张",
                    "相同点数的基础牌",
                },
            },
            c_mxms_flat_earth = {
            ...
            c_mxms_hoax = {
                ...
                text = {
                    "{C:green}#1#/#2#{}几率",
                    "将至多{C:attention}#3#{}张选定牌",
                    "改为同色对应花色",
                    "{C:inactive}({C:hearts}红桃{C:inactive}<>{C:diamonds}方片{C:inactive} {C:clubs}梅花{C:inactive}<>{C:spades}黑桃{C:inactive})",
                },
            },
            c_mxms_landing = {
                name = "登月",
                text = {
                    "{C:green}#1#/#2#{}几率",
                    "为你{C:attention}最少{}打出的牌型",
                    "增加{C:attention}#3#{}个等级",
                },
            },
            c_mxms_mib = {
                name = "黑衣人",
            ...
            c_mxms_nwo = {
                ...
                text = {
                    ...
                    "手牌中每有1张{C:clubs}梅花{}",
                    "给1张{C:green}随机{}小丑牌",
                    "添加1个{C:green}随机{C:dark_edition}版本{}",
                },
            },
            c_mxms_pyramid = {
                name = "金字塔",
        ...
        Horoscope = {
            ...
            c_mxms_pisces = {
                ...
                text = {
                    ...
                    "生成1张{C:green}随机{C:spectral}幻灵牌{}",
                    "{C:inactive}当前: #2#/#1#",
                },
            },
            c_mxms_sagittarius = {
        ...
        Joker = {
            ...
            j_mxms_abyss = {
                ...
                text = {
                    ...
                    "有{C:green}50/50{}几率",
                    "为1张{C:green}随机{}持有的",
                    "非负片小丑牌添加{C:dark_edition}负片{}",
                    "或{C:red}摧毁{}1张{C:green}随机{}",
                    "持有的非负片小丑牌",
            ...
            j_mxms_adrenaline = {
                name = "肾上腺素",
                text = {
                    "当处于本回合{C:attention}最后一次出牌{}时",
                    "本回合剩余期间",
                    "手牌上限{C:attention}+#1#{}",
                    "弃牌次数{C:red}+#2#{}",
                    "{C:inactive,s:0.8}出自: 杀戮尖塔",
                },
            },
            j_mxms_apophenia = {
                name = "空想性错视",
                text = {
                    "打出的牌包含{C:attention}顺子{}时",
                    "生成1张{C:dark_edition}负片{C:conspiracy}阴谋牌{}",
                },
            },
            j_mxms_bankrupt = {
                name = "破产",
            ...
            j_mxms_fortune_cookie = {
                name = "幸运饼干",
                text = {
                    "每次出牌有{C:green}#1#/#2#{}几率",
                    "生成1张{C:green}随机{C:tarot}塔罗牌{}",
                    "{s:0.8,C:inactive}(必须有空位)",
                    "{C:green}几率{}每次出牌降低{C:attention}#3#{}",
                },
            },
            ...
            j_mxms_illuminati = {
                ...
                text = {
                    "每回合结束时",
                    "生成{C:attention}#1#{}张{C:conspiracy}阴谋牌{}",
            ...
            j_mxms_occam = {
                ...
                text = {
                    "{X:mult,C:white}X#1#{}倍率",
                    "每张打出的牌",
                    "使倍率减少{X:mult,C:white}X1{}",
                    "{C:inactive}(每次出牌时重置)",
                    "{C:inactive,s:0.8}基础X倍率取决于出牌数量限制",
                },
            },
            ...
            j_mxms_raz = {
                ...
                text = {
                    {
                        "所有{C:attention}同花{}和",
                        "{C:attention}顺子{}可由{C:attention}3{}张牌组成",
                    },
                    {
                        "每回合1次",
                        "如果出牌包含{C:attention}同花{}或{C:attention}顺子{}",
                        "{C:attention}立即{}达成所有持有的",
                        "{C:horoscope}星座牌{}要求",
                        "{C:inactive,s:0.8}(如果可以)",
                    },
                },
                unlock = {
                    "{E:1,s:1.3}?????",
            ...
            j_mxms_secret_society = {
                ...
                text = {
                    "点数的{C:chips}筹码{}数值",
                    "被{C:attention}互换{}并{C:attention}翻倍{}",
                    "{C:inactive,s:0.8}(例如 A: {C:chips,s:0.8}+11{C:inactive,s:0.8}筹码 -> {C:chips,s:0.8}+#1#{C:inactive,s:0.8}筹码 -> {C:chips,s:0.8}+#2#{C:inactive,s:0.8}筹码",
                    "{C:inactive,s:0.8}2: {C:chips,s:0.8}+2{C:inactive,s:0.8}筹码 -> {C:chips,s:0.8}+#3#{C:inactive,s:0.8}筹码 -> {C:chips,s:0.8}+#4#{C:inactive,s:0.8}筹码)",
                },
            },
            j_mxms_semisolid = {
                name = "半固体平台",
            ...
            j_mxms_sisyphus = {
                ...
                text = {
                    ...
                    "{C:inactive}(当前为{X:mult,C:white}X#2#{C:inactive}倍率)",
                    "{C:inactive,s:0.8}出自: Golden Features - Sisyphus 专辑",
                },
            },
            j_mxms_sleuth = {
                name = "侦查",
            ...
            j_mxms_substitute = {
                name = "替身",
                text = {
                    "防止接下来{C:attention}#1#{}次",
                    "{C:attention}小丑牌{}被{C:red}摧毁{}",
                },
            },
            j_mxms_tar_pit = {
                name = "沥青坑",
            ...
            j_mxms_ufo = {
                ...
                text = {
                    {
                        "{C:conspiracy}阴谋牌{}生效{C:green}概率{}",
                        "{X:green,C:white}X#1#{}",
                    },
                    {
                        "每回合结束后",
                        "有{C:green}#2#/#3#{}几率被{C:red}摧毁{}",
                    },
                },
            },
            j_mxms_under_construction = {
                ...
                text = {
                    "{C:attention}#3#{}个回合后",
                    "售出以获得{C:attention}+#1#{}小丑牌槽位",
                    "{C:inactive,s:0.8}(当前 #2#/#3#)",
                },
            },
            j_mxms_unpleasant_gradient = {
                name = "违和梯度",
                text = {
                    "若计分牌恰好有{C:attention}4{}张",
                    "则按从左到右的顺序",
                    "分别转化为",
                    "{C:clubs}梅花{}、{C:hearts}红桃{}、{C:diamonds}方片{}和{C:spades}黑桃{}",
                    "{C:inactive,s:0.8}出自: Meme",
                },
            },
            j_mxms_vinyl_record = {
            ...
            j_mxms_zombie = {
                name = "僵尸",
                text = {
                    "每回合复制{C:attention}1{}张{C:green}随机{C:attention}小丑牌{}的效果",
                    "目标小丑牌会在回合结束时",
                    "转化为{C:attention}另一张僵尸{}",
                    "{s:0.8,C:inactive}所有僵尸小丑牌的目标相同",
                    "{s:0.8,C:inactive}售出所有其他僵尸可停止僵尸化",
        ...
        Other = {
            p_mxms_classified_jumbo_1 = {
                ...
                text = {
                    "从最多{C:attention}#2#{}张",
                    "{C:conspiracy}阴谋牌{}中选择{C:attention}#1#{}张",
                    "即选即用",
                },
            },
            ...
            mxms_black_seal_fake_card = {
                ...
                text = {
                    ...
                    "这张牌不能被{C:attention}修改{}",
                    "或被{C:red}摧毁{}",
                    "{s:0.8,C:inactive}(不会自然出现)",
                },
            },
            mxms_conspiracy_desc = {
                name = "阴谋牌",
                text = {
                    "每持有1张其他{C:conspiracy}阴谋牌{}",
                    "概率{C:attention}增加{}{C:green}#1#{}",
                },
            },
            mxms_credits = {
                text = {
                    " {element:1} {}",
                    "{s:0.4} {}",
                    "{B:1,C:white}主要程序:{} {C:purple}theAstra",
                    "{B:2,C:white}主要美术:{} {C:attention}Maxiss02",
                    "{B:3,C:white}其他作者:{} {C:conspiracy}anerdymous",
        ...
        Sleeve = {
            ...
            sleeve_mxms_dummy_alt = {
                ...
                text = {
                    "回合结束时",
                    "如果当前{C:money}${}等于资金上限{C:inactive}($#1#){}",
                    "资金上限{C:attention}增加{}{C:money}$#2#",
                    "{C:inactive,s:0.8}(最高上限为$#3#)",
                },
            },
            sleeve_mxms_empire = {
                name = "帝国牌套",
        ...
        Spectral = {
            c_mxms_doppelganger = {
                name = "分身",
                text = {
                    "{C:attention}立即{}达成{C:attention}所有{}",
                    "持有的{C:horoscope}星座牌{}要求",
                    "{C:inactive,s:0.8}(如果可以)",
                },
            },
            c_familiar = {
    ...
    misc = {
        achievement_descriptions = {
            ...
            ach_mxms_champion = "使用专家牌组并启用黄金赌注获胜",
            ach_mxms_commitment = "组建一副完全由带有暗之蜡封的牌组成的牌组",
            ach_mxms_conspirator = "发现每一张阴谋牌",
            ...
            ach_mxms_scars = "发现每一张Maximus传奇小丑牌",
        ...
        achievement_names = {
            ...
            ach_mxms_champion = "世界冠军",
            ach_mxms_commitment = "这是我的承诺",
            ach_mxms_conspirator = "共谋者",
            ach_mxms_copy = "假冒操作",
        ...
        dictionary = {
            ...
            b_conspiracy_cards = "阴谋牌",
            b_mxms_credits = "制作",
            b_mxms_custom_menu = "使用定制菜单",
            b_mxms_enable_handtypes = "使用新牌型",
            b_mxms_enable_conspiracies = "启用阴谋牌",
        ...
        v_text = {
            ...
            ch_c_mxms_bullseye_requirement = {
                "{C:attention,T:j_mxms_bullseye}正中靶心{}必须至少拥有{C:chips}+#1#{}筹码",
            },
            ch_c_mxms_bullseye_requirement2 = {
                "在{C:attention}底注8 Boss{}结束前",
            },
            ch_c_mxms_feast = {
                "只有{C:attention}食物小丑牌{}能出现",
                "包括{C:attention,T:j_mxms_microwave}微波炉{}和{C:attention,T:j_mxms_refrigerator}冰箱{}",
            },
            ...
            ch_c_mxms_picky = {
                "1张{C:attention,T:j_mxms_four_course_meal}四菜套餐{}会生成在手牌中",
            },
            ch_c_mxms_picky2 = {
                "每回合开始时如果有空位",
            },
            ch_c_mxms_biggest_loser = {
                "{C:attention,T:j_mxms_impractical_joker}愚钝小丑{}以{C:attention}同花顺{}开局",
            },
            ...
            ch_c_mxms_coexist = {
                "如果没有持有{C:green,T:j_mxms_zombie}僵尸{}则{C:red}游戏结束{}",
            },
            ch_c_mxms_coexist2 = {
                "或所有{C:attention}小丑牌槽位{}都被{C:green,T:j_mxms_zombie}僵尸{}填满",
            },
            ch_c_mxms_speedrun = {
        ...
        v_dictionary = {
            a_mxms_jokersize = "+#1#小丑牌槽位",
            a_mxms_blackjack_hand_value = "当前点数总值: #1#",
        },
        playlog_types = {
            mxms_horoscope_success = "星座牌成功",
            mxms_horoscope_fail = "星座牌失败",
            mxms_horoscope_increment = "星座牌进度增加",
        },
        playlog = {
            horoscope_area = "星座牌槽位",
            mxms_horoscope_success = "星座牌{C:mxms_horoscope}#1#{}成功",
            mxms_horoscope_fail = "星座牌{C:mxms_horoscope}#1#{}失败",
            mxms_horoscope_increment = "星座牌{C:mxms_horoscope}#1#{}进度增加 {C:attention}#2#{} -> {C:attention}#3#",
        },
    },
}
